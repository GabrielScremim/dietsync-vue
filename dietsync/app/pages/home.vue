        ...
        <Row>
            <div class="col-md-6">
                ...
                <div class="row text-center">
                    <div class="col-md-6">
                        <div class="card mb-4">
                            <img src="http://152.67.45.167/img/IMG_20240128_201042_006.jpg" class="card-img-top"
                                alt="Desenvolvedor 1">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4">
                            <img src="http://152.67.45.167/img/segobi.jpeg" class="card-img-top" alt="Desenvolvedor 2">
                            <div class="card-body">
            ...
            <div class="col-md-6">
                ...
                <p>O DietSync é uma ferramenta fitness dedicado a ajudar você a alcançar seus objetivos de saúde e
                    bem-estar.
                    Desenvolvido por uma equipe comprometida, oferecemos ferramentas para registrar sua dieta, treinos e
                    obter
